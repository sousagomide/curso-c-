...
namespace SalesWebMVC.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Seller s1 = new Seller(1, "Anderson Félix de Araújo Júnior", "anderson.araujo@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(1998, 4, 21), DateTimeKind.Utc), 1000.00, d1);
            Seller s2 = new Seller(2, "Gabriel Pereira Lemes", "gabriel.lemes@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(2000, 10, 18), DateTimeKind.Utc), 1000.00, d1);
            Seller s3 = new Seller(3, "Jefte Yuri Silva Cereja", "jefte.cereja@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(2004, 1, 15), DateTimeKind.Utc), 1000.00, d1);
            Seller s4 = new Seller(4, "João Carlos Costa Carvalho", "-", DateTime.SpecifyKind(new DateTime(2004, 5, 15), DateTimeKind.Utc), 1500.00, d2);
            Seller s5 = new Seller(5, "Milleny Lara da Silva Basilio", "milleny.basilio@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(2008, 10, 15), DateTimeKind.Utc), 1500.00, d2);
            Seller s6 = new Seller(6, "Marielle Rodrigues Vaz", "marielle.vaz1@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(2004, 5, 10), DateTimeKind.Utc), 900.00, d3);
            Seller s7 = new Seller(7, "Rayan Brenno Rodrigues Rosa", "rayan.rosa@estudante.ifgoiano.edu.br", DateTime.SpecifyKind(new DateTime(2003, 2, 28), DateTimeKind.Utc), 900.00, d4);
            /*
            ...
            SalesRecord r13 = new SalesRecord(13, new DateTime(2018, 09, 29), 10000.0, SaleStatus.Billed, s7);
            ...
            SalesRecord r21 = new SalesRecord(21, new DateTime(2018, 10, 17), 9000.0, SaleStatus.Billed, s7);
